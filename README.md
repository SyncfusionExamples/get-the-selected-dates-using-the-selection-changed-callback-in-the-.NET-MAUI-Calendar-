...
This repository contains a sample to get the selected dates using the selection changed callback in the [SfCalendar](https://help.syncfusion.com/maui/calendar/getting-started) control.
